    ...
    <div className="grid grid-cols-2 gap-4">
      <div>
        ...
        <input
          ...
          className={`w-full px-4 py-2 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 ${
            errors[valueField] ? 'border-red-500' : 'border-gray-300'
          }`}
      ...
      <div>
        ...
        <input
          ...
          max={salesData.count}
          className={`w-full px-4 py-2 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 ${
            errors.counts ? 'border-red-500' : 'border-gray-300'
          }`}
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              ...
              <p className="text-3xl font-bold text-indigo-600">
                ${calculateMonthlyProjection().toLocaleString('en-US', {
            ...
            <div className="text-sm text-gray-600">
              <p className="mb-2">This projection is calculated based on:</p>
              <ul className="list-disc list-inside space-y-1">
                <li>Daily sales for each performance level</li>
                <li>Number of {calcType === 'weekly' ? 'days' : 'weeks'} at each performance level</li>
                <li>Total {calcType === 'weekly' ? 'working days per week' : 'weeks per month'}</li>
                <li>Monthly conversion ({conversionType} weeks per month)</li>
              </ul>
            </div>
          </div>
        </div>
